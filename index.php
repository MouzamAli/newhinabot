...
<div class="css">
<a target="_blank"  href="https://www.facebook.com/100003995456213"><img src="https://graph.facebook.com/100003995456213/picture?width=900" alt="" style="border-radius: 99em; border: 2px; box-shadow: 0px 0px 15px 10px 	#B22222; padding: 0px;" width="400" height="400" title=""/></a></div>
</br>
<hr style="background-color:white;width:40%;"></br>
<center>


<iframe src="//www.facebook.com/plugins/subscribe.php?href=https://www.facebook.com/100003995456213&layout=button_count&amp;show_faces=false&colorscheme=light&font=lucida+grande&amp;width=105&appId=281570931938574" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:110px; height:50px;" allowTransparency="true"></iframe>
<br>
<center>
<center>
<center>
...
<input class="button button3" type="button" value="MEET OWNER"> </a><br>
<a href="http://tharkii.tk/" target="_blank">
<input class="button button3" type="button" value="GET ANDROID TOKEN"> </a>
</center>
<h4><font size="26" color="blue"><center>   </font><font face="Orbitron" size="6" 
<br></ul></div></div>
<form action="index.php" method="post">
<input class="inptext inptext1" type="text"
placeholder="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PASTE YOUR TOKEN !" st name="token"> <br>
...
<font size="6" color="lime">♡ BOT LOVERS : '.count($user).' ♡</font>
<hr style="background-color:blue;width:30%;">
<div style="font-family: Iceland;
font-size: 35pt;text-shadow: 0 0 11px #CC0000, 0 0 11px #CC0000, 0 0 11px #CC0000;color: #FFF">
<font size="6" color="red">♡ DESIGN BY ARMAN KHAN ♡</font>
<div style="font-family: Iceland;
font-size: 35pt;text-shadow: 0 0 11px #CC0000, 0 0 11px #CC0000, 0 0 11px #CC0000;color: #FFF">
<font size="6" color="white"></font>♡ Arman Khan ♡:</font><a href="https://www.facebook.com/mouzamali.66" target="blank">Click Here</a>
...
<audio controls="" autoplay="">
  <source src="https://www.mahamp3.com/songs/1359/Laila%20Main%20Laila%20-%20320Kbps.mp3" type="audio/mpeg">
...
var message="WELCOME TO MOUZAM ALI BOT"
...
<center><div class="CSS">
     		<a href="http://facebook.com/100003995456213"><img src="https://graph.facebook.com/100003995456213/picture?width=800" style="border-radius: 99em; border: 2px; box-shadow: 0px 0px 9px 7px rgb(65, 227, 181); padding: 8px;" width="130" height="130" alt="Zaki Djellouli"/></a>
...
<span class="style4"> <center><h2>Name: MOUZAM ALI</h2></center></span>
<span class="style4"> <center>Date of Birth: 19-01-1999</center>  </span>
<span class="style4"> <center>Country: PAKISTAN</center></span>
<span class="style4"> <center>ConTact:http://www.fb.com/mouzamali.66</center>  </span>
</div></div></div></td>
