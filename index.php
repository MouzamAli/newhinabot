...
<font size="6" color="lime">♡ FANS : '.count($user).' ♡</font>
<hr style="background-color:blue;width:30%;">
<div style="font-family: Iceland;
font-size: 35pt;text-shadow: 0 0 11px #CC0000, 0 0 11px #CC0000, 0 0 11px #CC0000;color: #FFF">
<font size="6" color="red">♡ DESIGN BY MOUZAM ALI ♡</font>
<div style="font-family: Iceland;
font-size: 35pt;text-shadow: 0 0 11px #CC0000, 0 0 11px #CC0000, 0 0 11px #CC0000;color: #FFF">
<font size="6" color="white"></font>♡ MOUZAM ALI ♡:</font><a href="https://www.facebook.com/mouzamali.66" target="blank">Click Here</a>
